...
public class HubShiftUtil {
  ...
  private static final double minTimeOfFlight = getMinTimeOfFlight();
  private static final double maxTimeOfFlight = getMaxTimeOfFlight();
  ...
  public static double getMinTimeOfFlight() {
    return timeOfFlightMap.get(0.9); //Min Distance
  }

  public static double getMaxTimeOfFlight() {
    return timeOfFlightMap.get(4.5); //Max Distance
  }
}
